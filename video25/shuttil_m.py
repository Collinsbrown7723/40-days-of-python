...
#shutil.copyfile('notes.txt', 'fold/note.txt')

# Copying a.txt to c.txt. a.txt is in the current working directory
# It copies the file data and the files permission mode. Other metadata is not preserved
shutil.copy('out.txt', 'here.txt')
...
shutil.move('noooooioo.txt', 'notes.txt')   # renaming b.txt to x.txt
